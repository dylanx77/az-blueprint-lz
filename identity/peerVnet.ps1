...
$vnetName = 'dev-identity-vnet-test'
$vnetResourceGroup = 'rg-network-identity-dev-eastus'
...
$routingConfig = New-AzRoutingConfiguration -AssociatedRouteTable $hubRt.Id -Id @($defaultRt.Id, $hubRt.Id) -Label @("default")
